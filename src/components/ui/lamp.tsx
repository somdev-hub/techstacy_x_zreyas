...
export const LampContainer = ({
  ...
  return (
    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 h-full transform -translate-y-32">
        <motion.div
      ...
      <div className="absolute inset-0 z-50 flex flex-col items-center justify-center px-5 space-y-16">
        ...
        <motion.a
          ...
          className="mt-16"
        >
          <div className="text-slate-400 font-semibold flex flex-col items-center">
            Scroll Down
